...
<style scoped>
  ...
  .banner-nav .banner-list li .banner-item {
  ...
  .banner-nav .banner-list .banner-li:hover{
    background-image: url("./icon1.png");
    background-repeat: no-repeat;
    background-position: 100% 50%;
    background-color: #60646D;
  }
  .banner-nav .banner-list li:hover > .hide_menu {
    display: block;
  }
  /*二级菜单*/
  .hide_menu{
