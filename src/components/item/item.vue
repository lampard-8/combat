    ...
    <div class="item">
      ...
      <div class="navcenter">
        <div class="list">
          ...
          <span id="擦玻璃" class="clickAble "><a href="#">擦玻璃</a></span>
      ...
      <div class="service-center">
        <div class="centerleft">
          ...
          <span class="ranking">
                ...
                <a href="#" id="comment" class="">好评多 <img src="./fuwu_down2.jpg" width="12" height="7"></a>
